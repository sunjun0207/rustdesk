...
// Custom server (test.xuandou.vip): hbbs at 118.178.233.1:21116, hbbr at 118.178.233.1:21117
pub const RENDEZVOUS_SERVERS: &[&str] = &["118.178.233.1"];
pub const RS_PUB_KEY: &str = "Tk+j2wI9FSwqoxRARvA7q6oPOPAiVc7yjuKBs0vWaL8=";
